 ...
 *   <li>1일 누적 검토 기준을 넘었으면 &mdash; 위험이 아니라 <b>절차</b>다. 겁줄 일이 아니다.
 *       고객에게 "규정/보고" 라고 말하지 않는다 &mdash; 지금 값은 데모 기준이고, 실제
 *       규정을 확인하기 전에 그렇게 말하면 <b>없는 근거를 고객에게 대는 것</b>이다</li>
 * </ul>
 *
...
public class GuidanceComposer {
    ...
    private List<String> actionSteps(ResponseTier tier, Set<String> codes) {
        ...
        if (codes.contains("DAILY_CUMULATIVE_THRESHOLD")) {
            steps.add("오늘 보낸 금액이 확인 기준을 넘었습니다. 위험하다는 뜻은 아니고 "
                      + "확인 절차가 필요한 금액입니다.");
        }
