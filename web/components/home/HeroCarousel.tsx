 ...
 * 보는가(2), 실행을 누가 통제하는가(3)로 갈린다. 3번은 "기록됩니다"가 문구의
 * 핵심이라 조사 화면이 아니라 감사 로그 화면(/admin/fraud/audit)으로 보낸다 —
 * 카피가 가리키는 것과 실제로 여는 화면이 같아야 한다.
 *
 * <p><b>링크는 해당 기능 화면을 바로 가리킨다.</b> 로그인 주소를 적어 두지 않는다 —
